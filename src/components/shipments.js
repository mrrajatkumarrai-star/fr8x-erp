...
const SHIP_STATUSES = ['Booking Created', 'Booking Confirmed', 'CRO Received', 'Empty Released', 'Container Picked', 'Stuffing Done', 'Gate In', 'Vessel Sailed', 'In Transit', 'Transshipment', 'Arrival POD', 'Customs Clearance', 'DO Released', 'Delivered', 'Container Returned', 'Closed'];
      ...
      <div class="modal-bg" id="shipment-form-modal">
        <div class="modal" style="width: 620px;">
          ...
          <form id="ship-form" onsubmit="event.preventDefault()">
            ...
            <div class="form-row">
              <div class="fg"><label>Packages</label><input id="f-packages" type="number" value="${editData ? editData.packages || '' : ''}"/></div>
